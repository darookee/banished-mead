...
ConsumeProduceDescription consumeproduce
{
	...
	[
		...
		}
		{
			...
			[
				{
					ComponentDescription _material = "Template/RawMaterialHoney.rsc";
					int _count = 60;
				}
			]
			ComponentDescription _produceMaterial = "Template/RawMaterialMead.rsc";
			ResourceLimit _resourceLimit = Alcohol;

			String _requirements = "MeadHoneyRequire";
		}
	]
